...
function _slicedToArray$3(r, e) {
	return _arrayWithHoles$3(r) || _iterableToArrayLimit$3(r, e) || _unsupportedIterableToArray$2$1(r, e) || _nonIterableRest$3();
}
		...
		for (var i = 0; i < args.length; i++) {
			...
			if (type === "string" || type === "number") classes.push(className);
				...
				var _classes = Array.isArray(className) ? className : Object.entries(className).map(function(_ref) {
					var _ref2 = _slicedToArray$3(_ref, 2), key = _ref2[0];
	...
	return _createClass$1(DomHandler, null, [
			...
			value: function setAttributes(element) {
				...
				if (element) {
					...
					Object.entries(attributes).forEach(function(_ref5) {
						var _ref6 = _slicedToArray$3(_ref5, 2), key = _ref6[0], value = _ref6[1];
		...
		},
		{
			...
			value: function isDocument(obj) {
				return (typeof Document === "undefined" ? "undefined" : _typeof$4(Document)) === "object" ? obj instanceof Document : obj && _typeof$4(obj) === "object" && obj !== null && obj.nodeType === 9;
			}
		},
		{
			key: "scrollInView",
		...
		},
		{
			...
			value: function getTargetElement(target) {
				...
				else if (_typeof$4(target) === "object" && target.hasOwnProperty("current")) return this.isExist(target.current) ? target.current : null;
...
*/
_defineProperty$4(DomHandler, "DATA_PROPS", ["data-"]);
/**
* All ARIA properties like aria-label and focus-target for https://www.npmjs.com/package/@q42/floating-focus-a11y
*/
_defineProperty$4(DomHandler, "ARIA_PROPS", ["aria", "focus-target"]);
function _extends$6() {
	...
	return _createClass$1(ObjectUtils, null, [
		{
			...
			value: function equals(obj1, obj2, field) {
				if (field && obj1 && _typeof$4(obj1) === "object" && obj2 && _typeof$4(obj2) === "object") return this.deepEquals(this.resolveFieldData(obj1, field), this.resolveFieldData(obj2, field));
		...
		},
		{
			...
			value: function getRefElement(ref) {
				if (ref) return _typeof$4(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
				return null;
			}
		},
		{
		...
		},
		{
			...
			value: function mutateFieldData(data, field, value) {
				if (_typeof$4(data) !== "object" || typeof field !== "string") return;
				var fields = field.split(".");
				var obj = data;
				for (var i = 0, len = fields.length; i < len; ++i) {
					if (i + 1 - len === 0) {
		...
		},
		{
			...
			value: function absoluteCompare(objA, objB) {
				...
				if (_typeof$4(objA) !== _typeof$4(objB)) return false;
		...
		},
		{
			...
			value: function selectiveCompare(a, b, keysToCompare) {
				...
				if (a === b) return true;
				if (!a || !b || _typeof$4(a) !== "object" || _typeof$4(b) !== "object") return false;
				...
				try {
					for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
						...
						var isObject = _typeof$4(aValue) === "object" && aValue !== null && _typeof$4(bValue) === "object" && bValue !== null;
	...
	return _createClass$1(IconUtils, null, [{
		...
		value: function getJSXIcon(icon) {
			...
			if (icon !== null) {
				...
				content = /* @__PURE__ */ import_react.createElement("span", _extends$6({}, iconProps, {
					className,
...
function mergeProps(props) {
	...
	return props.reduce(function(merged, ps) {
		...
		var _loop = function _loop() {
			var value = ps[key];
			if (key === "style") merged.style = _objectSpread$3(_objectSpread$3({}, merged.style), ps.style);
...
_defineProperty$3(PrimeReact$1, "changeTheme", function(currentTheme, newTheme, linkElementId, callback) {
...
var useStyle = function useStyle(css) {
	var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
	var _useState2 = _slicedToArray$2((0, import_react.useState)(false), 2), isLoaded = _useState2[0], setIsLoaded = _useState2[1];
...
var ComponentBase = {
	...
	extend: function extend() {
		...
		var css = props.css;
		var defaultProps = _objectSpread$2(_objectSpread$2({}, props.defaultProps), ComponentBase.defaultProps);
		var inlineStyles = {};
		...
		var getPTValue = function getPTValue() {
			...
			var datasetProps = !isTransition && _objectSpread$2(_objectSpread$2({}, fkey === "root" && _defineProperty$2({}, "".concat(datasetPrefix, "name"), params.props && params.props.__parentMetadata ? ObjectUtils.toFlatCase(params.props.__TYPE) : componentName)), {}, _defineProperty$2({}, "".concat(datasetPrefix, "section"), fkey));
			return mergeSections || !mergeSections && self ? useMergeProps ? mergeProps([
				globalPT,
				self,
				Object.keys(datasetProps).length ? datasetProps : {}
			], { classNameMergeFunction: (_ComponentBase$contex = ComponentBase.context.ptOptions) === null || _ComponentBase$contex === void 0 ? void 0 : _ComponentBase$contex.classNameMergeFunction }) : _objectSpread$2(_objectSpread$2(_objectSpread$2({}, globalPT), self), Object.keys(datasetProps).length ? datasetProps : {}) : _objectSpread$2(_objectSpread$2({}, self), Object.keys(datasetProps).length ? datasetProps : {});
		};
		return _objectSpread$2(_objectSpread$2({
			...
			setMetaData: function setMetaData() {
				...
				var ptm = function ptm() {
					...
					return getPTValue((props || {}).pt, key, _objectSpread$2(_objectSpread$2({}, metadata), params));
				};
				...
				return {
					...
					sx: function sx() {
						...
						if (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true) {
							...
							var self = _getOptionValue(css && css.inlineStyles, key, _objectSpread$2({
								props,
								state
							}, params));
							return mergeProps([_getOptionValue(inlineStyles, key, _objectSpread$2({
								props,
								state
					...
					cx: function cx() {
						var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
						var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
						return !isUnstyled() ? _getOptionValue(css && css.classes, key, _objectSpread$2({
							props,
							state
						}, params)) : void 0;
					},
...
var _usePT = function _usePT(pt, callback, key, params) {
	...
	if (pt !== null && pt !== void 0 && pt.hasOwnProperty("_usept")) {
		...
		return mergeSections || !mergeSections && value ? useMergeProps ? mergeProps([originalValue, value], { classNameMergeFunction }) : _objectSpread$2(_objectSpread$2({}, originalValue), value) : value;
	}
	return fn(pt);
};
...
//#endregion
//#region node_modules/primereact/icons/chevronleft/index.esm.js
function _extends$4() {
...
var ChevronLeftIcon = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	var pti = IconBase.getPTI(inProps);
...
var Ripple = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	var _React$useState2 = _slicedToArray$1(import_react.useState(false), 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
	...
	var _RippleBase$setMetaDa = RippleBase.setMetaData(_objectSpread$1({}, metaData)), ptm = _RippleBase$setMetaDa.ptm, cx = _RippleBase$setMetaDa.cx;
	...
	return /* @__PURE__ */ import_react.createElement("span", _extends$1({
		role: "presentation",
		ref: inkRef
...
//#endregion
//#region node_modules/primereact/carousel/carousel.esm.js
function _typeof(o) {
	"@babel/helpers - typeof";
	...
	css: {
		classes: {
			...
			previousButton: function previousButton(_ref2) {
				...
				return classNames("p-carousel-prev p-link", { "p-disabled": isDisabled });
			},
			previousButtonIcon: "p-carousel-prev-icon",
			nextButton: function nextButton(_ref3) {
				var isDisabled = _ref3.isDisabled;
				return classNames("p-carousel-next p-link", { "p-disabled": isDisabled });
			},
			nextButtonIcon: "p-carousel-next-icon",
			indicator: function indicator(_ref4) {
				var isActive = _ref4.isActive;
				return classNames("p-carousel-indicator", { "p-highlight": isActive });
			},
		...
		inlineStyles: { itemsContent: function itemsContent(_ref7) {
			return { height: _ref7.height };
		} }
	}
});
...
var CarouselItem = /* @__PURE__ */ import_react.memo(function(props) {
	var mergeProps = useMergeProps();
	...
	return /* @__PURE__ */ import_react.createElement("div", itemClonedProps, content);
});
var Carousel = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	var mergeProps = useMergeProps();
	var context = import_react.useContext(PrimeReactContext);
	var props = CarouselBase.getProps(inProps, context);
	var _React$useState2 = _slicedToArray(import_react.useState(props.numVisible), 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
	var _React$useState4 = _slicedToArray(import_react.useState(props.numScroll), 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
	var _React$useState6 = _slicedToArray(import_react.useState(props.page * props.numScroll * -1), 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
	var _React$useState8 = _slicedToArray(import_react.useState(props.page), 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
	...
	var itemsContainerRef = import_react.useRef(null);
	var remainingItems = import_react.useRef(0);
	var allowAutoplay = import_react.useRef(!!props.autoplayInterval);
	var attributeSelector = import_react.useRef("");
	var swipeThreshold = import_react.useRef(20);
	var startPos = import_react.useRef(null);
	var interval = import_react.useRef(null);
	var carouselStyle = import_react.useRef(null);
	var indicatorContent = import_react.useRef(null);
	var isRemainingItemsAdded = import_react.useRef(false);
	var responsiveOptions = import_react.useRef(null);
	...
	var bindWindowResizeListener = _slicedToArray(useResizeListener({
	...
	var step = function step(dir, page) {
		...
		if (page != null) {
			...
			if (isCircular) totalShiftedItems = totalShiftedItems - numVisibleState;
	...
	var calculatePosition = function calculatePosition() {
		if (itemsContainerRef.current && responsiveOptions.current) {
			...
			if (numScrollState !== matchedResponsiveData.numScroll) {
				...
				if (isCircular) totalShiftedItems = totalShiftedItems - matchedResponsiveData.numVisible;
				setTotalShiftedItemsState(totalShiftedItems);
				setNumScrollState(matchedResponsiveData.numScroll);
				changePage(page);
			}
			if (numVisibleState !== matchedResponsiveData.numVisible) setNumVisibleState(matchedResponsiveData.numVisible);
		}
	};
	var navBackward = function navBackward(e, page) {
		if (circular || currentPage !== 0) step(1, page);
		allowAutoplay.current = false;
		if (e.cancelable) e.preventDefault();
	};
	var navForward = function navForward(e, page) {
		if (circular || currentPage < totalIndicators - 1) step(-1, page);
		allowAutoplay.current = false;
		if (e.cancelable) e.preventDefault();
	};
	var onIndicatorClick = function onIndicatorClick(e, page) {
		if (page > currentPage) navForward(e, page);
		else if (page < currentPage) navBackward(e, page);
	};
	var onTransitionEnd = function onTransitionEnd(e) {
		if (itemsContainerRef.current && e.propertyName === "transform") {
			...
			if ((pageState === 0 || pageState === totalIndicators - 1) && isCircular) changePosition(totalShiftedItemsState);
		}
	};
	...
	var _onTouchEnd = function onTouchEnd(e) {
		var touchobj = e.changedTouches[0];
		if (isVertical) changePageOnTouch(e, touchobj.pageY - startPos.current.y);
		else changePageOnTouch(e, touchobj.pageX - startPos.current.x);
	};
	var changePageOnTouch = function changePageOnTouch(e, diff) {
		if (Math.abs(diff) > swipeThreshold.current) if (diff < 0) navForward(e);
		else navBackward(e);
	};
	...
	var onHomeKey = function onHomeKey() {
		changedFocusedIndicator(findFocusedIndicatorIndex(), 0);
	};
	var onEndKey = function onEndKey() {
		...
		changedFocusedIndicator(findFocusedIndicatorIndex(), indicators.length - 1);
	};
	...
	var startAutoplay = function startAutoplay() {
		if (props.autoplayInterval > 0) interval.current = setInterval(function() {
			if (pageState === totalIndicators - 1) step(-1, 0);
			else step(-1, pageState + 1);
	...
	var createStyle = function createStyle() {
		if (!carouselStyle.current) carouselStyle.current = DomHandler.createInlineStyle(context && context.nonce || PrimeReact.nonce, context && context.styleContainer);
	...
	var changePosition = function changePosition(totalShiftedItems) {
		if (itemsContainerRef.current) itemsContainerRef.current.style.transform = isVertical ? "translate3d(0, ".concat(totalShiftedItems * (100 / numVisibleState), "%, 0)") : "translate3d(".concat(totalShiftedItems * (100 / numVisibleState), "%, 0, 0)");
	};
	...
	useMountEffect(function() {
		...
		if (!carouselStyle.current) {
			...
			} else changePosition(totalShiftedItemsState);
	...
	useUpdateEffect(function() {
		...
		var totalShiftedItems = totalShiftedItemsState;
		createStyle();
		if (props.autoplayInterval) stopAutoplay();
		if (prevNumScroll !== numScrollState || prevNumVisible !== numVisibleState || props.value && prevValue && prevValue.length !== props.value.length) {
			...
			if (page === totalIndicators - 1 && remainingItems.current > 0) {
				...
				isRemainingItemsAdded.current = true;
			} else isRemainingItemsAdded.current = false;
		...
		if (isCircular) {
			if (pageState === 0) totalShiftedItems = -1 * numVisibleState;
			else if (totalShiftedItems === 0) {
				totalShiftedItems = -1 * props.value.length;
				if (remainingItems.current > 0) isRemainingItemsAdded.current = true;
			}
			if (totalShiftedItems !== totalShiftedItemsState) {
				setTotalShiftedItemsState(totalShiftedItems);
				stateChanged = true;
		...
		if (prevPage !== props.page) {
			if (props.page > prevPage && props.page <= totalIndicators - 1) step(-1, props.page);
			else if (props.page < prevPage) step(1, props.page);
		}
		if (!stateChanged && isAutoplay) startAutoplay();
		return function() {
			if (props.autoplayInterval) stopAutoplay();
			destroyStyle();
		};
	...
	var createItems = function createItems() {
		if (props.value && props.value.length) {
			...
			return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
		}
	};
	var createHeader = function createHeader() {
		if (props.header) {
			var headerProps = mergeProps({ className: cx("header") }, ptm("header"));
			return /* @__PURE__ */ import_react.createElement("div", headerProps, props.header);
		}
		return null;
	};
	var createFooter = function createFooter() {
		if (props.footer) {
			var footerProps = mergeProps({ className: cx("footer") }, ptm("footer"));
			return /* @__PURE__ */ import_react.createElement("div", footerProps, props.footer);
		}
		return null;
	};
	var createContent = function createContent() {
		...
		return /* @__PURE__ */ import_react.createElement("div", containerProps, backwardNavigator, /* @__PURE__ */ import_react.createElement("div", itemsContentProps, /* @__PURE__ */ import_react.createElement("div", _extends({ ref: itemsContainerRef }, itemsContainerProps), items)), forwardNavigator);
	};
	var createBackwardNavigator = function createBackwardNavigator() {
		if (props.showNavigators) {
			...
			var previousButtonIconProps = mergeProps({ className: cx("previousButtonIcon") }, ptm("previousButtonIcon"));
			var icon = isVertical ? props.prevIcon || /* @__PURE__ */ import_react.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || /* @__PURE__ */ import_react.createElement(ChevronLeftIcon, previousButtonIconProps);
			var backwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, previousButtonIconProps), { props });
			...
			return /* @__PURE__ */ import_react.createElement("button", previousButtonProps, backwardNavigatorIcon, /* @__PURE__ */ import_react.createElement(Ripple, null));
		}
		return null;
	};
	var createForwardNavigator = function createForwardNavigator() {
		if (props.showNavigators) {
			...
			var nextButtonIconProps = mergeProps({ className: cx("nextButtonIcon") }, ptm("nextButtonIcon"));
			var icon = isVertical ? props.nextIcon || /* @__PURE__ */ import_react.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || /* @__PURE__ */ import_react.createElement(ChevronRightIcon, nextButtonIconProps);
			var forwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, nextButtonIconProps), { props });
			...
			return /* @__PURE__ */ import_react.createElement("button", nextButtonProps, forwardNavigatorIcon, /* @__PURE__ */ import_react.createElement(Ripple, null));
		}
		return null;
	};
	...
	var createIndicator = function createIndicator(index) {
		...
		var getPTOptions = function getPTOptions(key) {
			return ptm(key, { context: { active: isActive } });
		};
		...
		return /* @__PURE__ */ import_react.createElement("li", _extends({}, indicatorProps, { key }), /* @__PURE__ */ import_react.createElement("button", indicatorButtonProps, /* @__PURE__ */ import_react.createElement(Ripple, null)));
	};
	var createIndicators = function createIndicators() {
		if (props.showIndicators) {
			var _indicators = [];
			for (var i = 0; i < totalIndicators; i++) _indicators.push(createIndicator(i));
			...
			return /* @__PURE__ */ import_react.createElement("ul", indicatorsProps, _indicators);
		}
		return null;
	};
	...
	var contentProps = mergeProps({ className: classNames(props.contentClassName, cx("content")) }, ptm("content"));
	return /* @__PURE__ */ import_react.createElement("div", rootProps, header, /* @__PURE__ */ import_react.createElement("div", contentProps, content, indicators), footer);
}));
